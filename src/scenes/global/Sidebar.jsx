...
import ConfirmationNumberOutlinedIcon from "@mui/icons-material/CalendarTodayOutlined";
...
import PersonOutlineIcon from "@mui/icons-material/PeopleAltOutlined"; // For "Customer Manager"
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            >
              ...
              <Item
                title="Tickets"
                to="/cm"
                icon={<ConfirmationNumberOutlinedIcon />} // Tickets icon
                selected={selected}
                setSelected={setSelected}
              />
              <Item
                title="Customer"
                to="/hob"
                icon={<PersonOutlineIcon />} // Customer icon
                selected={selected}
                setSelected={setSelected}
              />
